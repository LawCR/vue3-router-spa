<template>
  <div class=" flex justify-center items-center mb-14 py-7">
    <div class="">
      ...
      <div class="pt-8 lg:pt-20 px-4 lg:px-2 flex flex-col lg:flex-row gap-y-8">
        <!-- Basic Card -->
        <div class="w-full lg:w-96 p-8 bg-white text-center rounded-3xl pr-16 shadow-xl">
        ...
        <!-- StartUp Card -->
        <div
          class="w-full lg:w-80 p-8 bg-gray-900 text-center rounded-3xl text-white border-4 shadow-xl border-white transform scale-100 lg:scale-125">
        ...
        <!-- Enterprise Card -->
        <div class="w-full lg:w-96 p-8 bg-white text-center rounded-3xl pl-16 shadow-xl">
